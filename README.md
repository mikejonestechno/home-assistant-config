...
Open http://localhost:8123/ in a browser and start the onboarding setup to initialize the local database.

Go to http://localhost:8123/developer-tools/yaml and restart Home Assistant to reload the local configuration.yaml.